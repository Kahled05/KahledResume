...
<div id="container">
    <div id="profile">
        <div id="image">
            <img id="profile-photo" src="https://scontent.fmnl25-3.fna.fbcdn.net/v/t39.30808-6/411246710_6636116669844511_8560222220699623970_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=XoDtSUEvg44AX_uFzG5&_nc_ht=scontent.fmnl25-3.fna&oh=00_AfA9zrHgJURzD5wARurqLl_qDA0MiHucJf7ZBX5WFB8xJA&oe=65A174EC" alt="Profile-Image">
            <a href="#"><i class="fas fa-pen stroke-transparent"></i></a>
        </div>
        <p id="name">John Kahled Macapagal<br><span id="email">macapagaljohnkahled05@gmail.com</span></p>
       ...
       <hr width="100%">
        ...
        <p id="year-graduation">Expected Year of Graduation<br><strong>2026</strong></p>
        ...
        <p id="telephone">Telephone<br><strong>09345678910</strong></p>
        <p id="fax">Facebook<br><strong>@Kahled05</strong></p>
    </div>
    <div id="info-cards">
        ...
        <div class="card">
            ...
            <ul>
                <li><p class="tags">AT & T<br><span>Los Angeles CA | <span>2018</span></span></p>
                    <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
                <li><p class="tags">Cebu Pacific<br><span>Cebu, PH | <span>2021</span></span></p>
                    <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
        ...
        <div class="card">
            ...
            <ul>
                <li><p class="tags">Holy Cross College<br><span>Bachelor of Science in Information Technology | <span>June 2025</span></span></p>
                    <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
                <li><p class="tags">Sucad National High School<br><span>TVL Industrial Arts | <span>April 2021</span></span></p>
                    <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
